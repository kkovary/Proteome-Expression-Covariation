...
$$\sigma_{{}_{norm}} = \dfrac{\sqrt{\sigma_{{}_{total}}}}{n}$$
...
```{r figure_3, echo=FALSE, fig.height=6, fig.width=7, message=FALSE, warning=FALSE, eval=TRUE, fig.cap=fig_legend_3}
plots <- 1:4
...
wrap_plots(left, right) + plot_annotation(tag_levels = "A") + plot_layout(nrow = 2)
...
```{r figure_4, echo=FALSE, fig.height=6, fig.width=6, message=FALSE, warning=FALSE, eval=TRUE, fig.cap=fig_legend_3}
library(circlize)
