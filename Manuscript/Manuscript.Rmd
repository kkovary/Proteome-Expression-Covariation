...
To fetch bibliographic metadata automatically from the web. For example, citing a paper can be as easy as providing its DOI `r citep("10.1016/j.tree.2006.03.016")` or even just a few keywords `r citep(c("Heterogeneous ribosomes preferentially translate distinct subpools of mRNAs genome-wide","Controlling low rates of cell differentiation through noise and ultrahigh feedback"))`.
